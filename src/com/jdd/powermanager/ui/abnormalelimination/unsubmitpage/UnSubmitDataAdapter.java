...
public class UnSubmitDataAdapter extends BaseAdapter 
{
	...
	public void submitSelected()
	{
		...
		{
			ToastHelper.showToastShort(mContext, mContext.getString(R.string.no_meter_to_submit_tip));
		...
		String waitTip = String.format(mContext.getString(R.string.submit_wait_tip_meter), ""+size);
